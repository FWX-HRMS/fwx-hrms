...
const translations = {
  en: {
    ...
    statUnpaidTaken: "Unpaid Leave Approved",
    ...
    applyHourlyLeaveBtn: "Apply for Hourly Leave",
    hourlyLeaveLimitsNote: "Maximum 4 hours per request, 4 hours per month, 48 hours per year.",
    dateLabel: "Date",
    fromTimeLabel: "From",
    toTimeLabel: "To",
    ...
    limitExceededPopupTitle: "Request Not Submitted",
    ...
    takenSickThisYearLabel: "Sick leave already taken this year (days)",
    takenThisYearNote: "Only needed if there's no previous year balance to draw from.",
    takenThisYearEditNote: "Only the amount manually recorded here — separate from any real leave the employee submitted themselves. Editing and saving replaces this amount, not the employee's own requests.",
    ...
    resetVacationCounterTitle: "Delete all leave records and reset?",
    resetVacationConfirmDeleteBtn: "Yes, delete everything",
    resetVacationCounterMsg: "Choose \"Yes, reset\" to restart tenure and leave tracking from today's date (a fresh start — entitlement tier and accrual calculate from now on). Choose \"Cancel\" to keep the original hiring date, and you'll be prompted to manually update the taken-leave figures instead.",
    resetVacationCounterYesBtn: "Yes, reset",
    resetVacationBalanceStandaloneMsg: "This PERMANENTLY DELETES every stored leave request for %name% — annual, sick, hourly, unpaid, all of it — and resets their hiring date to today plus their previous-year balance to zero. This cannot be undone.",
    resetVacationBalanceBtn: "Reset vacation balance",
    editVacationBalanceBtn: "Edit vacation balance",
    unfreezeNextActionTitle: "What would you like to do next?",
    unfreezeDateLabel: "Date of unfreeze",
    editEmployeeProfileBtn: "Edit Employee Profile",
    keepPreviousProfileBtn: "Keep previous Profile",
    skipBtn: "Skip",
    vacationBalanceResetToast: "Vacation balance reset.",
    vacationBalanceUpdatedToast: "Vacation balance updated.",
    pleaseUpdateTakenLeaveToast: "Please update the leave already taken this year, then save.",
    ...
    deleteBtn: "Delete",
    editLeaveRequestTitle: "Edit leave request",
    savedToast: "Saved.",
    ...
    employeeActiveNewPasswordTitle: "Employee is now active",
    employeeActiveNewPasswordMsg: "%name% is now active in the system. New password: <strong>%password%</strong><br><br>Share this with them securely.",
  ...
  ar: {
    ...
    statSickTakenLabel: "المستخدم المرضي",
    statHourlyMonth: "المغادرة الساعية المستخدمة هذا الشهر",
    statHourlyYear: "المغادرة الساعية المستخدمة هذا العام",
    statUnpaidTaken: "الإجازة غير المدفوعة المعتمدة",
    ...
    applyHourlyLeaveBtn: "طلب مغادرة",
    hourlyLeaveLimitsNote: "الحد الأقصى 4 ساعات لكل طلب، 4 ساعات شهرياً، و48 ساعة سنوياً.",
    dateLabel: "التاريخ",
    fromTimeLabel: "من",
    toTimeLabel: "إلى",
    ...
    colPeriod: "المدة",
    monthsLabel: "أشهر",
    colAnnual: "الاستحقاق السنوي حتى نهاية العام",
    colPrevYearBalance: "رصيد العام السابق",
    colTaken: "مستخدم",
    colRemaining: "الرصيد المتاح",
    colPending: "معلق",
    colSick: "الاستحقاق المرضي",
    ...
    limitExceededPopupTitle: "لم يتم إرسال الطلب",
    ...
    takenSickThisYearLabel: "الإجازة المرضية المستخدمة هذا العام (أيام)",
    takenThisYearNote: "مطلوب فقط في حال عدم وجود رصيد من العام السابق.",
    takenThisYearEditNote: "فقط المبلغ المُدخل يدوياً هنا — منفصل عن أي إجازة حقيقية قدّمها الموظف بنفسه. التعديل والحفظ يستبدل هذا المبلغ فقط، وليس طلبات الموظف الخاصة.",
    ...
    resetVacationCounterTitle: "حذف جميع سجلات الإجازات وإعادة التعيين؟",
    resetVacationConfirmDeleteBtn: "نعم، احذف كل شيء",
    resetVacationCounterMsg: "اختر \"نعم، إعادة التعيين\" لبدء احتساب الأقدمية والإجازات من تاريخ اليوم من جديد (بداية جديدة — يُحتسب الاستحقاق والتراكم من الآن). اختر \"إلغاء\" للإبقاء على تاريخ التعيين الأصلي، وسيُطلب منك تحديث أرقام الإجازات المستخدمة يدوياً بدلاً من ذلك.",
    resetVacationCounterYesBtn: "نعم، إعادة التعيين",
    resetVacationBalanceStandaloneMsg: "سيؤدي هذا إلى حذف جميع طلبات الإجازة المخزّنة لـ %name% نهائياً — السنوية والمرضية والساعية وغير المدفوعة، كل شيء — وإعادة تعيين تاريخ التعيين إلى اليوم ورصيد السنة السابقة إلى صفر. لا يمكن التراجع عن هذا الإجراء.",
    resetVacationBalanceBtn: "إعادة تعيين رصيد الإجازات",
    editVacationBalanceBtn: "تعديل رصيد الإجازات",
    unfreezeNextActionTitle: "ماذا تود أن تفعل الآن؟",
    unfreezeDateLabel: "تاريخ إلغاء التجميد",
    editEmployeeProfileBtn: "تعديل ملف الموظف",
    keepPreviousProfileBtn: "الإبقاء على الملف السابق",
    skipBtn: "تخطي",
    vacationBalanceResetToast: "تمت إعادة تعيين رصيد الإجازات.",
    vacationBalanceUpdatedToast: "تم تحديث رصيد الإجازات.",
    pleaseUpdateTakenLeaveToast: "يرجى تحديث الإجازات المستخدمة هذا العام ثم الحفظ.",
    ...
    deleteBtn: "حذف",
    editLeaveRequestTitle: "تعديل طلب الإجازة",
    savedToast: "تم الحفظ.",
    ...
    employeeActiveNewPasswordTitle: "الموظف نشط الآن",
    employeeActiveNewPasswordMsg: "%name% أصبح الآن نشطاً في النظام. كلمة المرور الجديدة: <strong>%password%</strong><br><br>شارك هذه البيانات معه بطريقة آمنة.",
