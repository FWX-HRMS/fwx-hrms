...
const translations = {
  en: {
    ...
    resetVacationCounterTitle: "Reset vacation balance counter?",
    ...
    resetVacationBalanceStandaloneMsg: "This resets %name%'s hiring date to today, restarting tenure and leave tracking from scratch. This can't be undone automatically.",
  ...
  ar: {
    ...
    resetVacationCounterTitle: "إعادة تعيين عداد رصيد الإجازات؟",
    ...
    resetVacationBalanceStandaloneMsg: "سيؤدي هذا إلى إعادة تعيين تاريخ التعيين لـ %name% إلى اليوم، وإعادة احتساب الأقدمية والإجازات من جديد. لا يمكن التراجع عن هذا تلقائياً.",
