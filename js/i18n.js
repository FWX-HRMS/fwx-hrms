...
const translations = {
  en: {
    ...
    takenThisYearEditNote: "Current total for this year — editing and saving replaces it.",
  ...
  ar: {
    ...
    takenThisYearEditNote: "الإجمالي الحالي لهذا العام — التعديل والحفظ يستبدله.",
